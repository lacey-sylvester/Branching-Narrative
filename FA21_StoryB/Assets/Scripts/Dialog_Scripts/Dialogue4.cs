...
public class Dialogue4 : MonoBehaviour
{
    ...
    {         // main story function. Players hit next to progress to next int
        ...
        {
            Char1name.text = "YOU";
            Char1speech.text = "Ahh, the good ol' days...Gran and I would work on crosswords out here for hours...";
            Char2name.text = "";
            Char2speech.text = "";
        }
        else if (primeInt == 9)
        ...
        {
            Char1name.text = "YOU";
            Char1speech.text = "Strange, cicadas aren't usually active in the fall…";
            Char2name.text = "";
            Char2speech.text = "";
            Char3name.text = "";
            Char3speech.text = "";
