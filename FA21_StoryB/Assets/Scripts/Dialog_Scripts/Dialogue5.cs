...
public class Dialogue5 : MonoBehaviour
{
    ...
    {         // main story function. Players hit next to progress to next int
        ...
        else if (primeInt == 2)
        {
            ...
            Char1name.text = "YOU";
            Char1speech.text = "I’m surprised, Gran would never leave a crossword unfinished. Let’s see…";
            Char2name.text = "";
            Char2speech.text = "";
        }
        else if (primeInt == 3)
        {
            ...
            Char1speech.text = "";
            Char2name.text = "";
            Char2speech.text = ">You ponder at the puzzle for a while, trying to figure it out.";
